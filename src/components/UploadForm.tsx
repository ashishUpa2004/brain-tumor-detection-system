    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-5 py-4 min-h-[52px] text-lg border border-gray-300 dark:border-cyan-500/30 rounded-xl focus:ring-0 focus:border-gray-400 dark:focus:ring-2 dark:focus:ring-cyan-400 dark:focus:border-transparent outline-none transition-all bg-white dark:bg-[#0a1628] text-[#1E293B] dark:text-gray-200 placeholder-gray-600 dark:placeholder-[#94a3b8]"
        ...
        <div
          ...
          className={`
            ...
            ${isDragging 
              ...
              : 'border-gray-300 dark:border-cyan-500/30 hover:border-cyan-400 active:border-cyan-400'
            }
