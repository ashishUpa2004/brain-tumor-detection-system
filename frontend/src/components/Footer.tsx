      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="font-medium text-[#1E293B] dark:text-gray-100">
                Secure & Encrypted
              </p>
        ...
        {/* Copyright and Links */}
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          ...
          <div className="flex space-x-6 text-xs">
            <a
              href="#"
              className="text-[#64748B] dark:text-gray-400 hover:text-[#3B82F6] dark:hover:text-blue-400 transition-colors"
            >
              Privacy Policy
            </a>
            <a
